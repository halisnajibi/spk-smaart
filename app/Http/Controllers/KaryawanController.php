...
class KaryawanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $cek = Karyawan::where('tahun_id', $request->tahun_id)->first();
        if ($cek == null || $cek->status_alternatif == $request->status_alternatif) {
            ...
            return \redirect('/alternatif')->with('alert-error', 'Data alternatif dengan tahun ' . $cek->tahun->kode . '-' . $cek->tahun->tahun . ' sudah ada dengan status alternatif ' . $cek->status_alternatif);
        }
    }
    ...
    public function cariAlternatif(Request $request)
    {
        return \view('alternatif.cari-alternatif', [
            ...
            'alternatifs' => Karyawan::where('tahun_id', $request->tahun_id)->get()
        ]);
    }
}
