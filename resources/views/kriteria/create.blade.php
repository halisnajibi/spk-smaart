...
@section('content')
    ...
    <div class="intro-y datatable-wrapper box p-5 mt-5">
        <form class="validate-form" novalidate="novalidate"  method="POST" action="/kriteria">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div class="flex items-center text-gray-700 mt-2"> <input type="radio" class="input border mr-2" id="vertical-radio-chris-evans" name="label" value="const"> <label class="cursor-pointer select-none" for="vertical-radio-chris-evans">Const</label> 
                </div>
                <div class="flex items-center text-gray-700 mt-2"> <input type="radio" class="input border mr-2" id="benefit" name="label" value="benefit"> <label class="cursor-pointer select-none" for="benefit">Benefit</label> 
                </div>
                @error('label')
                <label id="name-error" class="error" for="name">{{ $message }}</label>
                @enderror
