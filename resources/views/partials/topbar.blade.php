                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">{{ date("d-m-Y ") }}</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">{{ date("H:i:s") }}</a> </div>
                    <!-- END: Bread                    {{-- <!-- BEGIN: Search -->
                    ...
                    <!-- END: Notifications -->crumb -->
 --}}
                    <!-- BEGIN: Account Menu -->
                    <div class="intro-x dropdown w-8 h-8 relative">
                        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in">
                            @if (Auth::user()->foto == 'user.png')
                            <img alt="{{ Auth::user()->name }}" src="{{ asset('assets/dist/images/').'/'.Auth::user()->foto }}">
                            @else     
                            <img alt="{{ Auth::user()->name }}" src="{{ asset('storage').'/'.Auth::user()->foto }}">
                            @endif
                        </div>
                        <div class="dropdown-box mt-10 absolute w-56 top-0 right-0 z-20">
                            <div class="dropdown-box__content box bg-theme-38 text-white">
                                ...
                                <div class="p-2">
                                    <a href="/user" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
                                </div>
