...
@section('content')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            Laporan Skor Penilaian Alternatif
        </h2>
    </div>
    <form action="/laporan/skor/cari" method="post">
        @csrf
        ...
        <div class="rounded-md px-5 py-4 mb-2 border text-gray-700">
            ...
            <div class="mt-3">Silahkan cari data berdasarkan tahun di atas untuk mendapatkan data skor dari alternatif dan bisa dicetak pdf.</div>
        </div>
    @endsection
