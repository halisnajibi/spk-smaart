...
@section('content')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            Laporan Kriteria & Bobot
        </h2>
    </div>
    <form action="/laporan/kriteria/cari" method="post">
        @csrf
        ...
        <div class="rounded-md px-5 py-4 mb-2 border text-gray-700">
            ...
            <div class="mt-3">Silahkan cari data berdasarkan tahun di atas untuk mendapatkan data kriteria dan bobot yang sudah di konversi dan bisa dicetak pdf.</div>
        </div>
    @endsection
