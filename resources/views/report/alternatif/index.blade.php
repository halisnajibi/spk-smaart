...
@section('content')
    ...
    <form action="/laporan/alternatif/cari" method="post">
        @csrf
        ...
        <div class="rounded-md px-5 py-4 mb-2 border text-gray-700">
            ...
            <div class="mt-3">Silahkan cari data berdasarkan tahun di atas untuk mendapatkan data alternatif dan bisa dicetak pdf.</div>
        </div>
    @endsection
